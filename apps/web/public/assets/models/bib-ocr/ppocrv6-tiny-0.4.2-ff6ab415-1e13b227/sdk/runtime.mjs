...
const DEFAULT_MODEL_ASSETS = {
  "PP-OCRv5_mobile_det": {
    url: "/assets/models/bib-ocr/ppocrv6-tiny-0.4.2-ff6ab415-1e13b227/remote-model-fallback-disabled"
  },
  "PP-OCRv5_mobile_rec": {
    url: "/assets/models/bib-ocr/ppocrv6-tiny-0.4.2-ff6ab415-1e13b227/remote-model-fallback-disabled"
  },
...
async function loadOrtModule() {
  ...
  ortModulePromise = import("./vendor/ort-stub.mjs");
  return ortModulePromise;
}
    ...
    if (!this.initPromise) {
      ...
      if (ortOpts["wasmPaths"] === void 0 && true) {
        console.warn(
          ...
          "/assets/models/bib-ocr/ppocrv6-tiny-0.4.2-ff6ab415-1e13b227/ort/"
        );
      }
      const wasmCdnFallback = ortOpts["wasmPaths"] === void 0 && true ? { wasmPaths: "/assets/models/bib-ocr/ppocrv6-tiny-0.4.2-ff6ab415-1e13b227/ort/" } : {};
...
globalThis.__photostreamBibOcrRuntime = { create: (options) => PaddleOCR.create(options) };
