        ...
        <div className="min-h-0">
          ...
          >
            <DialogDescription className="leading-6">
              本网站由学生个人开发者（昵称：CCA3370）开发、维护，作为北航实验学校中学部校团委学生会电视台的活动照片发布平台运行，仅用于校园活动纪实、师生观赏留念及平台许可范围内的下载，不作为长期存储或公开传播平台。考虑到个人维护能力、运行成本、数据留存与隐私保护等因素，活动照片服务将在活动结束后数周内停止；确需留存且获准下载的照片，请尽早保存并妥善保管。
            </DialogDescription>
            <p>
              本平台现场拍摄影像资料版权及相关权益归学校或相应权利人所有，另有署名或约定的除外；自主开发程序及原创界面版权归 CCA3370 所有。
            </p>
            <p>
