    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          isPaddingless &&
            "[&>[data-slot=dialog-footer]]:mx-0! [&>[data-slot=dialog-footer]]:mb-0!",
          className,
        )}
        {...props}
      >
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/50 p-4 empty:hidden sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
