...
| ADR | 决策 | 状态 |
| --- | --- | --- |
| [ADR-001](001-client-side-media-processing.md) | 照片派生与号码候选在上传者浏览器完成；视频/人脸/地域由 ADR-011/012/013 修订 | Accepted, Amended |
| [ADR-002](002-webp-over-avif.md) | 首版照片派生选择 WebP 而不是 AVIF | Accepted |
| [ADR-003](003-mainland-media-hong-kong-control-plane.md) | 原杭州媒体数据面与香港控制面分离；地域由 ADR-013 改为北京 | Accepted, Amended |
...
| [ADR-007](007-school-privacy-defaults.md) | 学校相册默认口令、审核和禁下载；人脸找图/地域由 ADR-012/013 修订 | Accepted, Amended |
...
| [ADR-012](012-consent-gated-face-photo-search.md) | 口令相册采用阿里云 IMM 提供同意门禁的人脸候选找图；地域由 ADR-013 修订 | Accepted, Amended |
