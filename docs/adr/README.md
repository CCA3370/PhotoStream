...
| ADR | 决策 | 状态 |
| --- | --- | --- |
| [ADR-001](001-client-side-media-processing.md) | 照片派生与号码候选在上传者浏览器完成；视频/人脸旁路由 ADR-011/012 修订 | Accepted, Amended |
...
| [ADR-007](007-school-privacy-defaults.md) | 学校相册默认口令、审核和禁下载；人脸找图边界由 ADR-012 修订 | Accepted, Amended |
...
| [ADR-012](012-consent-gated-face-photo-search.md) | 口令相册采用阿里云 IMM 提供同意门禁的人脸候选找图 | Accepted |
